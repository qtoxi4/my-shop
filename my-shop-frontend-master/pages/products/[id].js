        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="p-4 lg:p-8 border">
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 my-3">
              <div>
                <label className="text-text font-semibold">Бренд</label>
              ...
              <div>
                <label className="text-text font-semibold">Стать</label>
                <p className="mt-2 text-accent list-disc list-inside">
                  {product?.gender}
                </p>
              </div>
            ...
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 my-3">
              <div>
                <label className="text-text font-semibold">Розмір</label>
                <p className="mt-2 text-accent list-disc list-inside">
                  {product?.sizes}
                </p>
              </div>
              ...
              <div>
                <label className="text-text font-semibold">Колір</label>
                <p className="mt-2 text-accent list-disc list-inside">
                  {product?.colors}
                </p>
              </div>
            ...
            <div className="mt-4 flex justify-between items-center">
              <h2 className="text-xl font-semibold text-gray-900">Ціна</h2>
