          ...
          <div className=" md:w-2/3  px-4">
            <div className=" mt-16 md:mt-6 ">
              ...
              {loading ? (
                ...
                <p className="my-6 text-center ">Ваш кошик порожній</p>
              ) : (
                <>
                  {products?.length > 0 &&
                    ...
                    <div className=" max-w-md space-y-4">
                      <dl className="space-y-0.5 text-md text-gray-700">
                        <div className="flex justify-end text-red-400 border-b mb-3">
                          <button onClick={deleteCart}>Очистити кошик</button>
                        </div>
                        <div className="flex justify-between">
                          <dt>Проміжний підсумок</dt>
                          <dd>{formatPrice(total)} UAH</dd>
                        </div>

                        <strike className="flex justify-between">
                          <dt>ПДВ</dt>
                          <dd>{formatPrice(total / 10)} UAH</dd>
                        </strike>

                        <div className="flex justify-between !text-base font-medium">
                          <dt>Загалом</dt>
                          <dd>{formatPrice(total + total/10)} UAH</dd>
                        </div>
                      </dl>
            ...
            <div className="md:1/3 mt-16 md:mt-6">
              <header className="text-start flex flex-col w-full">
                ...
                <p className="mt-2 text-text text-lg">
                  Ми використовуємо дані вашого облікового запису для доставки.
                </p>
              </header>
      ...
      <div className="grid h-screen px-4 bg-white place-content-center">
        <div className="text-center">
          <p className="mt-4 text-text text-2xl">
            Ви повинні зареєструватися, щоб переглянути товари в кошику
          </p>
